...
// Calculate content width and apply 10% margin
const contentWidth = rightmostBoxX - leftmostBoxX + 150 + 150; // Add box widths
const horizontalMargin = contentWidth * 0.1; // 10% margin
...
// Calculate content height and apply 10% margin
const contentHeight = bottommostBoxY - topmostBoxY;
const verticalMargin = contentHeight * 0.1; // 10% margin
...
// DESKTOP SETTINGS:
// For desktop, apply tight bounding box with 10% margin
